...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    btnMainSendExpandLayoutNotification,
    btnMainSendNotificationActionBtn,
    btnMainSendMaxPriorityNotification,
    btnMainSendMinPriorityNotification,
    btnMainSendCombinedNotification, btnMainClearAllNotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        NotificationScheduler.setReminder(MainActivity.this,AlarmReceiver.class,21,16);
        Log.d("asdaxxx","123");
    }
    ...
    private void setDataForNotificationWithActionButton()
    {
        ...
        notificationBuilder.addAction(R.drawable.thumb_up, "Yes", pendingIntentYes);
        ...
        notificationBuilder.addAction(R.drawable.thumb_up, "No", pendingIntentNo);
        sendNotification();
    }
    ...
    private void setDataForCombinedNotification()
    {
        ...
        inboxStyle.setSummaryText("asda@gmail.com");
